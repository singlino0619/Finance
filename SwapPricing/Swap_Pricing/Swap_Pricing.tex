...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}3}]:} [['O/N', '2017/12/23', '2017/12/24', '0.014348'],
...
{\color{incolor}In [{\color{incolor}1}]:} \PY{k+kn}{import} \PY{n+nn}{csv}
        ...
        \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{sample\PYZus{}swaprate.csv}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{r}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{csvfile}\PY{p}{:}
            \PY{n}{reader\PYZus{}obj} \PY{o}{=} \PY{n}{csv}\PY{o}{.}\PY{n}{reader}\PY{p}{(}\PY{n}{csvfile}\PY{p}{)}
            \PY{c+c1}{\PYZsh{} rewritten header\PYZus{}obj by using next method(???)}
            \PY{n}{header\PYZus{}obj} \PY{o}{=} \PY{n+nb}{next}\PY{p}{(}\PY{n}{reader\PYZus{}obj}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
        ...
        <ipython-input-1-598ae1a76b85> in <module>()
          1 with open('sample\_swaprate.csv', 'r') as csvfile:
    ----> 2     reader\_obj = csv.reader(csvfile)
          3     \# rewritten header\_obj by using next method(???)
          4     header\_obj = next(reader\_obj)
          5     swap\_rate\_list = []
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}9}]:} [['O/N', '2017/12/23', '2017/12/24', 0.014348, 0.99996014603284633],
...
\end{itemize}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}10}]:} \PY{k}{def} \PY{n+nf}{get\PYZus{}end\PYZus{}day}\PY{p}{(}\PY{n}{maturity}\PY{p}{,} \PY{n}{start\PYZus{}day}\PY{p}{)}\PY{p}{:}
             \PY{n}{datetime\PYZus{}obj\PYZus{}start} \PY{o}{=} \PY{n}{datetime}\PY{o}{.}\PY{n}{datetime}\PY{o}{.}\PY{n}{strptime}\PY{p}{(}\PY{n}{start\PYZus{}day}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{Y/}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{m/}\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{n}{DF\PYZus{}LIST} \PY{o}{=} \PY{n}{get\PYZus{}DF}\PY{p}{(}\PY{n}{mm\PYZus{}list}\PY{p}{,} \PY{n}{swap\PYZus{}rate\PYZus{}list}\PY{p}{,} \PY{l+m+mi}{1}\PY{o}{/}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{;}
...
\end{Verbatim}
    ...
    % \begin{center}		%
    % \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Swap_Pricing_files/Swap_Pricing_13_1.png}
    % \end{center}
    % { \hspace*{\fill} \\    }
...
\end{Verbatim}
    ...
    % \begin{center}
    % \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Swap_Pricing_files/Swap_Pricing_14_2.png}
    % \end{center}
    % { \hspace*{\fill} \\}
