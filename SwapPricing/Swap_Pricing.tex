...
{\color{incolor}In [{\color{incolor}76}]:} \PY{k+kn}{import} \PY{n+nn}{numpy} \PY{k}{as} \PY{n+nn}{np}
         ...
         \PY{c+c1}{\PYZsh{}    discount\PYZus{}factor = [[] for i in range(list\PYZus{}len)]}
         \PY{c+c1}{\PYZsh{}    for i in range(0,list\PYZus{}len):}
          \PY{c+c1}{\PYZsh{}       discount\PYZus{}factor[i][0] = str(discount\PYZus{}factor[i][0])}
         \PY{c+c1}{\PYZsh{}    for i in range(0, list\PYZus{}len):}
          \PY{c+c1}{\PYZsh{}       discount\PYZus{}factor[i][0] = money\PYZus{}market\PYZus{}list[i][0]}
         \PY{c+c1}{\PYZsh{}    moji = str(discount\PYZus{}factor[0][0])}
             \PY{k}{return} \PY{n}{discount\PYZus{}factor}
         \PY{c+c1}{\PYZsh{}    return moji}
         
         \PY{n}{get\PYZus{}DF}\PY{p}{(}\PY{n}{mm\PYZus{}list}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
\end{Verbatim}
